    ...
    <>
      ...
      <div className="w-[100vw] relative">
        ...
        <main>
          ...
          {/* TEXT-1 */}
          <div className="w-[50vw] mx-auto mb-8vw">
          ...
          <div className="w-[50vw] mx-auto mb-[8.33338vw]">
            <div className="m-bodyText">
              <h1 className="mb-[21px] text-3xl">
                ...
                between our headquarters in Berlin and our offices in Los
                Angeles and Tokyo.
              </h1>
              <p className="text-[1.25rm]">
                ...
                What connects us is the shared belief that each of us has the
                skills and knowledge to contribute to something big: helping to
          ...
          <div className="w-[50vw] mx-auto mb-[8.33338vw]">
            <div className="m-bodyText">
              ...
              <p className="text-[1.25rm]">
                ...
                teams that are richly diverse, and thus able to explore problems
                from a wider set of perspectives. We don’t always agree with
                each other, but opinion and debate are valued and openly
                encouraged.
              </p>
            </div>
          </div>
          ...
          <div className="w-[50vw] mx-auto mb-[8.33338vw]">
            <div className="m-bodyText">
              ...
              <p className="text-[1.25rm]">
                ...
                German or English lessons. Plus, working in Germany means you
                can expect comprehensive health insurance for you and your
                family, as well as generous maternity and paternity leave.
                Office hours are flexible, but it’s not all work; we have
                several company and team outings throughout the year as well as
                a variety of fun, informal small-group activities.
              </p>
            </div>
          </div>
